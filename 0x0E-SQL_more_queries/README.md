...
<h2>Tasks</h2>
  ...
  <p>Write a script that lists all privileges of the MySQL users <code>user_0d_1</code> and <code>user_0d_2</code> on your server.</p>
        <p>File: <code>0-privileges.sql</code></p>
  <h3>
    1. Root user
  </h3>
...
<li>If the user <code>user_0d_1</code> already exists, your script should not fail</li>
        ...
        <p>File: <code>1-create_user.sql</code></p>
  <h3>
    2. Read user
  </h3>
...
<li>If the user <code>user_0d_2</code> already exists, your script should not fail</li>
        ...
        <p>File: <code>2-create_read_user.sql</code></p>
  <h3>
    3. Always a name
  </h3>
...
<li>If the table <code>force_name</code> already exists, your script should not fail</li>
        ...
        <p>File: <code>3-force_name.sql</code></p>
  <h3>
    4. ID can&#39;t be null
  </h3>
...
<li>If the table <code>id_not_null</code> already exists, your script should not fail</li>
        ...
        <p>File: <code>4-never_empty.sql</code></p>
  <h3>
    5. Unique ID
  </h3>
...
<li>If the table <code>unique_id</code> already exists, your script should not fail</li>
        ...
        <p>File: <code>5-unique_id.sql</code></p>
  <h3>
    6. States table
  </h3>
...
<li>If the table <code>states</code> already exists, your script should not fail</li>
        ...
        <p>File: <code>6-states.sql</code></p>
  <h3>
    7. Cities table
  </h3>
...
<li>If the table <code>cities</code> already exists, your script should not fail</li>
        ...
        <p>File: <code>7-cities.sql</code></p>
  <h3>
...
<li>The database name will be passed as an argument of the <code>mysql</code> command</li>
        ...
        <p>File: <code>8-cities_of_california_subquery.sql</code></p>
  <h3>
    9. Cities by States
  </h3>
...
<li>The database name will be passed as an argument of the <code>mysql</code> command</li>
        ...
        <p>File: <code>9-cities_by_state_join.sql</code></p>
  <h3>
    10. Genre ID by show
  </h3>
  <p>Import the database dump from <code>hbtn_0d_tvshows</code> to your MySQL server: download</p>
...
<li>The database name will be passed as an argument of the <code>mysql</code> command</li>
        ...
        <p>File: <code>10-genre_id_by_show.sql</code></p>
  <h3>
    11. Genre ID for all shows
  </h3>
  <p>Import the database dump of <code>hbtn_0d_tvshows</code> to your MySQL server: download (same as <code>10-genre_id_by_show.sql</code>)</p>
...
<li>The database name will be passed as an argument of the <code>mysql</code> command</li>
        ...
        <p>File: <code>11-genre_id_all_shows.sql</code></p>
  <h3>
    12. No genre
  </h3>
  <p>Import the database dump from <code>hbtn_0d_tvshows</code> to your MySQL server: download (same as <code>11-genre_id_all_shows.sql</code>)</p>
...
<li>The database name will be passed as an argument of the <code>mysql</code> command</li>
        ...
        <p>File: <code>12-no_genre.sql</code></p>
  <h3>
    13. Number of shows by genre
  </h3>
  <p>Import the database dump from <code>hbtn_0d_tvshows</code> to your MySQL server: download (same as <code>12-no_genre.sql</code>)</p>
...
<li>The database name will be passed as an argument of the <code>mysql</code> command</li>
        ...
        <p>File: <code>13-count_shows_by_genre.sql</code></p>
  <h3>
    14. My genres
  </h3>
  <p>Import the database dump from <code>hbtn_0d_tvshows</code> to your MySQL server: download (same as <code>13-count_shows_by_genre.sql</code>)</p>
...
<li>The database name will be passed as an argument of the <code>mysql</code> command</li>
        ...
        <p>File: <code>14-my_genres.sql</code></p>
  <h3>
    15. Only Comedy
  </h3>
  <p>Import the database dump from <code>hbtn_0d_tvshows</code> to your MySQL server: download (same as <code>14-my_genres.sql</code>)</p>
...
<li>The database name will be passed as an argument of the <code>mysql</code> command</li>
        ...
        <p>File: <code>15-comedy_only.sql</code></p>
  <h3>
    16. List shows and genres
  </h3>
  <p>Import the database dump from <code>hbtn_0d_tvshows</code> to your MySQL server: download (same as <code>15-comedy_only.sql</code>)</p>
...
<li>The database name will be passed as an argument of the <code>mysql</code> command</li>
        ...
        <p>File: <code>16-shows_by_genre.sql</code></p>
